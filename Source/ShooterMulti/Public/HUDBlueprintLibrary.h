 ...
 */
UCLASS()
class SHOOTERMULTI_API UHUDBlueprintLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	* @outparam	OutViewportPosition - the viewport coordinates for HUD drawing
	...
	*/
	UFUNCTION(BlueprintPure, Category = "HUD|Util")
		static void FindScreenEdgeLocationForWorldLocation(APlayerController* PlayerController, const FVector& InLocation, const float EdgePercent, FVector2D& OutViewportPosition, float& OutRotationAngleDegrees, bool &bIsOnScreen);
